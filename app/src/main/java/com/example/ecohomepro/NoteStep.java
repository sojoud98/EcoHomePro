...
class NoteStep extends Step<String> {

    private EditText NoteView;
     static String note = "none";

    public NoteStep(String stepTitle) {
        super(stepTitle);
    }
    ...
    protected View createStepContentLayout() {
        ...
        NoteView = new EditText(getContext());
        NoteView.setMinLines(5);
        NoteView.setHint("Your Notes");
        ///..
    ...
    public String getStepData() {
        ...
        Editable userName = NoteView.getText();
